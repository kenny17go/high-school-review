...
const base={
 exam:{id:'ceec-115-matha',subject:'math',academic_year:115,exam:'學測',variant:'數學A',sourceType:'ceec_official',source_title:'115學測數學A',source_url:'https://www.ceec.edu.tw/test.pdf',answer_url:'https://www.ceec.edu.tw/answer.pdf'},
 groups:[{id:'g18-20',stem:'共用題幹'}],
 questions:[
  {id:'q1',question_number:1,questionType:'single_choice',options:['A','B'],answer:{index:1},primary_unit:'機率',skill_tags:['期望值'],explanation:{concept:'機率',key_insight:'列出事件',solution:'計算後得B',common_errors:'漏算'}},
  {id:'q7',question_number:7,questionType:'multiple_choice',options:['A','B','C','D','E'],answer:{indices:[2,3]},primary_unit:'不等式',skill_tags:['圖形判讀'],explanation:{concept:'不等式',key_insight:'畫邊界',solution:'判斷區域',common_errors:'不等號方向'}},
  {id:'q13',question_number:13,questionType:'fill_blank',answer:{cells:['9','1','0']},primary_unit:'機率',skill_tags:['條件機率'],explanation:{concept:'條件機率',key_insight:'先算分母',solution:'得到9/10',common_errors:'條件顛倒'}},
  {id:'q19',question_number:19,questionType:'short_answer',answer:{grading:'manual_required',reference:'x-y-z=-1'},group_id:'g18-20',primary_unit:'空間向量',skill_tags:['平面方程式'],explanation:{concept:'法向量',key_insight:'用外積',solution:'代點求常數',common_errors:'漏常數'}}
 ]};
